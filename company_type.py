...
PROMPT_PROFILES: dict[CompanyType, dict[str, str]] = {
    CompanyType.GENERIC: {
        ...
        "personnel_prompt": (
            ...
            "Only include people who held their role at the END of the reporting period. "
            "Exclude anyone who resigned, left, or whose tenure ended before the period end "
            "(e.g. date ranges like 'to 1 February 2024' or 'from X to Y' mean they left).\n"
            "Each chief-level role (CEO, CFO, COO, etc.) must appear at most once — return "
            "only the person who held the role at period end. Assistant, interim, and deputy "
            "chief titles (e.g. 'Deputy CEO', 'Interim CFO') are separate roles and may have "
            "multiple holders.\n"
